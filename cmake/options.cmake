...
set_option_if_not_set(TYPECHECK_ENABLE_CLANG_TIDY "Use clang-tidy - ${in_source_msg}" ${default_if_in_dir})
...
set_option_if_not_set(TYPECHECK_ENABLE_CPP_CHECK "Use cppcheck - ${in_source_msg}" ${default_if_in_dir})
